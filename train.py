...
def training(dataset, opt, pipe, testing_iterations, saving_iterations,
    ...
    densify_iters=[max(50,int(opt.densification_interval/scale)) for scale in densify_grad_scalings]
    densify_split_Ns=[2 for scale in densify_grad_scalings]
    if use_hierarchical_split:
        densify_split_Ns=[max(1,int(2*scale*densify_split_N)) for scale in densify_grad_scalings]
